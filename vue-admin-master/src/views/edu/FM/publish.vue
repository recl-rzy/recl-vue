    ...
    <div id="list">
        ...
        <el-form :inline="true" class="demo-form-inline" style="margin-top: 20px; margin-left: 20px">
            ...
            <el-form-item>
                ...
                <el-select v-model="musicQuery.status" clearable placeholder="心情">
            ...
            <el-table-column label="操作" width="200" align="center">
                ...
                <el-button type="danger" size="mini" icon="el-icon-delete" @click="removeDataById(scope.row.id)">下架</el-button>
